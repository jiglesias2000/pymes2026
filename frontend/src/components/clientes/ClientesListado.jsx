          ...
          <table className="table table-hover table-sm table-striped align-middle mb-0">
            <thead>
              <tr>
                ...
                <th className="text-center">Credito Maximo</th>
              ...
              {Items &&
                Items.map((Item) => (
                  <tr key={Item.IdCliente}>
                    <td>{Item.Nombre}</td>
                    <td className="text-end">{Item.Cuit}</td>
                    <td className="text-end">
                      ${Number(Item.CreditoMaximo).toFixed(2)}
                    </td>
                    <td className="text-end">
                      {dayjs(Item.FechaIngreso).format("DD/MM/YYYY")}
                    </td>
